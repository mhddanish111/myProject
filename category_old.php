        ...
        <div class="last_projects">
		  ...
		  <?php 
			...
			if(mysql_num_rows($rsprod)>0)
			{
				...
				{
            		echo'<li><a href="'.$abspath.''.strtolower($_REQUEST['cid']).'/'.strtolower($resprod['eurl']).'.html" title="'.stripslashes($resprod['subcat']).'"><img src="'.$imagelist.$resprod['imagepath'].'" class="attachment-project-last wp-post-image" alt="'.stripslashes($resprod['subcat']).'" title="'.stripslashes($resprod['subcat']).'" height="179" width="200" />
