...
<table width="90%" height="33" border="0" cellpadding="6" cellspacing="0" class="text1">
  <tr>
    <td><h1><font color="#6B6B6B">C</font><font color="#6B6B6B">ontact Us</font></h1></td>
      ...
      <tr>
		...
		<table width="650" border="0" cellpadding="0" cellspacing="5" bgcolor="#FFFFFF" class="text1">
          <tr>
            ...
            <td width="490" align="center"><textarea name="contact_us" id="contact_us"><?php echo stripslashes($result['contactdesp']); ?> </textarea><script language="JavaScript" type="text/javascript">generate_wysiwyg("contact_us");</script> </td>
          </tr>
		  <tr>
            <td width="145">詳細 :</td>
            <td width="490" align="center"><textarea name="contact_usr" id="contact_usr"><?php echo stripslashes($result['ja_contactdesp']); ?> </textarea><script language="JavaScript" type="text/javascript">generate_wysiwyg("contact_usr");</script> </td>
          </tr>
          <tr>
            <td height="48" colspan="2" align="center"><br />
              <table width="240" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td align="center"><input type="image" src="images/save.gif" alt="submit" name="contactsubmit" width="99" height="30" border="0" /></td>
