...
$imageid = $_REQUEST['imagename'];
$sel = rs_select("db_image where id = '$imageid'","imagepath");
...
<table width="90%" height="33" border="0" cellpadding="6" cellspacing="0" class="text1">
  <tr>
    <td><h1><font color="#6B6B6B">Edit Gallery </font></h1></td>
    ...
    <td height="33" align="center" valign="top" bgcolor="#FFFFFF"><table width="50%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td valign="top"><table width="450" border="0" cellpadding="0" cellspacing="5" bgcolor="#FFFFFF" class="text1">
          <tr>
            <td>New <font color="#6B6B6B">Image</font>:</td>
            <td width="262" height="48"  ><label></label>
             <input name="subimage" id="glimage" type="file" class="inp5" />  </td>
		   </tr>
		   <tr>
            <td>Previous <font color="#6B6B6B">Image</font>:</td>
            <td width="262" height="48"  ><label></label>
             <img src="<?php echo $imagepath.$res['imagepath']; ?>" height="40" width="50" border="0"  />  </td>
		   </tr>
          <tr>
            <td height="48" colspan="2" align="center"><br />
              <table width="240" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td align="center"><input type="image" src="images/save.gif" alt="submit" width="99" height="30" border="0" name="editGallery" onclick="return addGallery();" /></td>
...
<input type="hidden" name="imagename" value="<?php echo $_REQUEST['imagename'];?>"  />
</form>
<br />
<br />
<br />
