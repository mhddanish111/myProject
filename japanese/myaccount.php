...
<div class="textfelid-box">
  ...
  <div class="continue-box"><input type="image" src="../images/updateuser.gif" alt="Update" name="updateuserprofile" width="93" height="30" border="0" onclick="return validateUpdate();" style="cursor:pointer;" /><span id="probar"></span></div>
</div></div>
</form>
</div>
</div>
