...
<!-- about start//-->
<div id="about-box">
<div id="welcome-heaading">ABOUT US </div>
<!-- about text start//-->
<div id="welcome-text">
  <div align="justify"><?php $selcon = mysql_query("select content from cmscontent where id='2'");
...
<!-- getin touch start//-->
<div id="get-touch">
<div id="touch-heaading-inn">STAY IN TOUCH </div>
