...
if(!empty($_REQUEST['sortby'])){
	if($_REQUEST['sortby']=="1"){ $orderby = "price ";$R_sortby=1;}
	else if($_REQUEST['sortby']=="2"){ $orderby = "price desc ";$R_sortby=2;}
	else if($_REQUEST['sortby']=="3") {$orderby = "id ";$R_sortby=3;}
	else if($_REQUEST['sortby']=="4"){$orderby = "id desc"; $R_sortby=4;}
}
...
<?php
			...
			if($maxPage>1)
		 	{
		 		//echo'<div id="paging-box">'.getPagination($numrows,$rowsPerPage,$pageNum,$abspath."sub-category.php?cid=".$_REQUEST['cid']."&sid=".$_REQUEST['sid']."&searchperpage=".$rowsPerPage."&sortby=".$R_sortby,"","4").'</div>';
				echo'<div id="paging-box">'.getPaginationForSearch($numrows,$rowsPerPage,$pageNum,$abspath."sub-category.php?cid=".$_REQUEST['cid']."&sid=".$_REQUEST['sid'],"","4").'</div>';
			}
?>
</div>
...
<div class="sort-searchbox">
    ...
    <select name="sortby" id="sortby" class="inp7" onchange="pageSubmit()">
