...
<div id="eng-box"><a href="#" class="tlink" id="tlink-active">Eng</a></div>
<div id="jp-box"><a href="'.$abspath.'japanese/index.php" class="tlink"><span id="result_box" lang="ja" xml:lang="ja"><span title="Click for alternate translations">&#26085;&#26412;</span></span></a></div>
</div>';
}
function nav($abspath)
{
	$selcat = mysql_query("select id,catname,eurl from category where status ='Y'");
	...
	echo'<ul>
            ...
            <li><a href="#"';
			   ...
			   {
			   		echo'<li><a href="'.$abspath.''.strtolower($rescat['eurl']).'.html">'.stripslashes($rescat['catname']).'</a></li>';
				}
                 echo'
               </ul>
            </li>
...
<div id="bottom-links">
						...
						<a href="'.$abspath.'our-staff.html">Our Staff</a> <a href="#">Our Products</a>
...
<div id="follow-heaading">Follow us</div>
					<div id="follow-box">
						<div class="follow">
							<a href="http://www.facebook.com/#!/pages/47th-Diamond-District-Corp/116716695076416" target="_blank" class="tooltip" title="47ddc on Facebook">
								<img src="'.$abspath.'images/facebook.jpg" alt="facebook" border="0" />
							</a>
						</div>
						<div class="follow">
							<a href="http://twitter.com/#!/47DDC" target="_blank" class="tooltip" title="Follow us on Twitter">
								<img src="'.$abspath.'images/tiwtter.jpg" alt="facebook" width="28" height="30" border="0" />
							</a>
						</div>
						<div class="follow">
							<a href="http://www.yelp.com/biz/47th-diamond-district-corp-manhattan" target="_blank" class="tooltip" title="Follow us on Yelp">
								<img src="'.$abspath.'images/yelp.jpg" alt="facebook" width="28" height="30" border="0" />
							</a>
						</div>
					</div>
...
<div id="icon-box">
  ...
  <div id="gia-box"><a href="http://www.agta.org/info/agta-source-directory-member-1032556.html" target="_blank"><img src="'.$abspath.'images/GIA.jpg" alt="GIA" border="0" /></a></div>
   <div id="jbt-box"><a href="http://www.agta.org/info/agta-source-directory-member-1032556.html" target="_blank"><img src="'.$abspath.'images/Jewelers_Board_Trade.jpg" alt="Jewelers Board Trade" border="0" /></a></div>
  </div>
...
function leftLink($abspath)
{
	...
	$rscat1 = rs_select("category where status ='Y' ","*");
		...
		if(strtolower(stripslashes($rescat1['eurl']))==$_REQUEST['cid'])
		{
			...
			while($ressub = mysql_fetch_assoc($rssub))
			{
				if($pagenavsub==2)
				{
					...
					{
						echo'<div class="sublink"><a href="'.$abspath.''.strtolower($_REQUEST['cid']).'/'.strtolower($ressub['eurl']).'/12/1/1.html" id="sublink-active">'.stripslashes($ressub['subcat']).'</a></div>';
					}
					else
					{
						echo'<div class="sublink"><a href="'.$abspath.''.strtolower($_REQUEST['cid']).'/'.strtolower($ressub['eurl']).'/12/1/1.html">'.stripslashes($ressub['subcat']).'</a></div>';
					}
				}
				else
				{
...
function showTitleFab($pageno)
{
  echo '<title>47th DDC; Diamonds, Gemstones, Jewelry, Watches and Art.</title>
        <link rel="shortcut icon" href="images/favicon.ico" type="image/x-icon">';
	//echo metaDescription($pageno);	
}
function metaDescription($pageno)
{
	$responce ="";
	$responce .='<meta name="description" content="47DDC, buyers and sellers of fine jewelry, watches and art. We are authorized sellers of Jacob & Co & Motion Swiss watches as well as designers of rare jewelry. Visit us for all your loose & specialty cut gemstones, diamonds and personalized jewelry needs as well as rare watch accessories."/>';
...
{
	$selcat = mysql_query("SELECT * FROM `category` WHERE catname !='' and status ='Y' ");
 $responce ="";
 $responce .='
...
<div class="search-felid-box">
  <select name="selectcat" id ="selectcat" class="inp3">
	...
	if(mysql_num_rows($selcat)>0)
	{
		...
		{
			$responce .='<option value="'.$res['eurl'].'">'.stripslashes($res['catname']).'</option>';
		}
	}
