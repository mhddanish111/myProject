...
<body bgcolor="#F5F3E3" onload="getServerResponse('showcouponcode','AjaxHandler.php?query=couponcode','',false);">
<center>
  <?php echo admin_top(); ?>
...
<table width="90%" height="33" border="0" cellpadding="6" cellspacing="0" class="text1">
  <tr>
    <td><h1><font color="#6B6B6B">A</font><font color="#6B6B6B">dd Offer Coupons</font></h1></td>
      ...
      <tr>
        <td valign="top"><form action="dbfunction.php" enctype="multipart/form-data" method="post">
          <table width="551" border="0" cellpadding="0" cellspacing="5" bgcolor="#FFFFFF" class="text1">
            <tr>
              <td>Coupon Code</td>
              <td><div id="showcouponcode"></div></td> <td width="108"><input type="button" name="showcou" name="showcou" value="Refresh Code" onclick="getServerResponse('showcouponcode','AjaxHandler.php?query=couponcode','',false);" maxlength="19" /></td>
            </tr>
            <tr>
              <td width="163">Coupons <font color="#6B6B6B">Name</font>:</td>
              <td width="260" height="48" align="left" ><label></label>
                  <input name="textfield22" type="text" class="inp2"  id="textfield22" onblur="getServerResponse('catdiv','AjaxHandler.php?query=checkcoupon&dublicate='+this.value,'',false)" /></td>
              <td width="108"><div id="catdiv" style="color:#FF0000"></div></td>
            </tr>
            <tr>
              <td width="163" >Coupons <font color="#6B6B6B">Message</font>:</td>
              <td height="48" align="left" colspan="2" ><textarea name="message" id="message" rows="4" cols="28"></textarea></td>
            </tr>
            <tr>
              <td width="163" >Coupons <font color="#6B6B6B">Amount</font>:</td>
              <td height="48" align="left" colspan="2" ><label></label>
                $&nbsp;
                <input name="amount" type="text" class="inp2"  id="amount"  /></td>
            </tr>
            <tr>
              <td>Publish:</td>
            ...
            <tr>
              <td height="48" colspan="2" align="center"><br />
                  <table width="240" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td align="center"><input type="image" src="images/save.gif" alt="submit" name="addcoupon" width="99" height="30" border="0" onclick="return addcoupon();" /></td>
