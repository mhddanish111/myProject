...
<div id="icon-box">
  ...
  <div id="secure-box"><a href="#" onclick="window.open(\'https://www.sitelock.com/verify.php?site=47ddc.com\',\'SiteLock\',\'width=600,height=600,left=160,top=170\');" ><img alt="website security" title="SiteLock"  src="//shield.sitelock.com/shield/47ddc.com" border="0"/> </a></div>
   ...
   <div id="agta-box"><a href="http://www.agta.org/info/agta-source-directory-member-1032556.html" target="_blank"><img src="'.$abspath.'images/agta_member_logo.jpg" alt="AGAT Member" width="84" height="80" border="0" /></a></div>
    <div id="jbt-box"><img src="'.$abspath.'images/Jewelers_Board_Trade.jpg" alt="Jewelers Board Trade" height="80" border="0"/></div>
 <div id="gia-box"><img src="'.$abspath.'images/GIA.jpg" alt="GIA" width="117" height="80" border="0" /></div>
