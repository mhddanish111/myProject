...
if(isset($_REQUEST['catadd_x']))
{
	...
	$jacatname = mysql_real_escape_string(trim($_REQUEST['jatextfield22']));
	...
	$flag1 = isFound("category","jacatname",$jacatname);
	if(($flag) && (flag1))
	{
	...
	{
		$rowAffected=rs_insert("category","catname,status,ja_catname,seotitle,keyword,seodescription,seojatitle,jakeyword,jaseodescription,eurl","'$catname','$status','$jacatname','$title','$keywords','$seodescription','$jatitle','$jakeywords','$jaseodescription','$eurl'");
...
else if($_REQUEST['catedit_x'])
{
	...
	$id = $_REQUEST['id'];
	$flag = isFound("category","eurl",$eurl);
	$flag1 = isFound("category","ja_catname",$jacatname);
	$rowAffected=rs_update("category","status='$status',seotitle='$title',keyword='$keywords',seodescription='$seodescription',seojatitle='$jatitle',jakeyword='$jakeywords',jaseodescription='$jaseodescription',eurl='$eurl'","id = '$id'");
	if(mysql_affected_rows()>0)
		$_SESSION["msg"]="Product Category Status Updated Successfully";
	else
		$_SESSION["msg"]="Product Category not Updated Successfully";	
	/*if(($flag) && ($flag1))
	{
		$rowAffected=rs_update("category","status='$status' ","id = '$id'");
		if(mysql_affected_rows()>0)
		{
			$_SESSION["msg"]="Product Category Status Updated Successfully";
		}
	...
	if(($flag) && (!$flag1))
	{
		$rowAffected=rs_update("category","ja_catname='$jacatname'","id = '$id'");
		if(mysql_affected_rows()>0)
		{
			$_SESSION["msg"]="Product Japanese Category Updated Successfully";
		}
		else
		{
			$_SESSION["msg"]="Product Category not Updated Successfully";
	...
	{
		$rowAffected=rs_update("category","catname='$catname'","id = '$id'");
		if(mysql_affected_rows()>0)
		{
	...
	{
		$rowAffected=rs_update("category","catname='$catname',ja_catname='$jacatname'","id = '$id'");
		if(mysql_affected_rows()>0)
		{
			$_SESSION["msg"]="Product both Category Updated Successfully";
		}
		else
		{
			$_SESSION["msg"]="Product Category not Updated Successfully";
...
else if (isset($_REQUEST['addsubcat_x']))
{
	...
	else if((!$flag) && (!$flag1))
	{
		...
		$_SESSION["msg"]="Product Sub Category Dulbicate not Allowed for english or Japanese";
		//header("Location:add-subcategory.php");
		//exit;	
...
else if(isset($_REQUEST['editsubcat_x']))
{
	...
	if(($flag) && ($flag1))
	{
		$rowAffected=rs_update("subcategory","status='$status'","id='$editid'");
		if(mysql_affected_rows()>0)
			$_SESSION["msg"]="Product Sub Category Added Successfully";
		else
			$_SESSION["msg"]="Product Sub Category not Added Successfully";
	...
	{
		$rowAffected=rs_update("subcategory","catid='$catid',subcat='$subcat',ja_subcat='$jasubcat',status='$status'","id='$editid'");
		if(mysql_affected_rows()>0)
			$_SESSION["msg"]="Product Sub Category Added Successfully";
		else
		{
	...
	{
		$rowAffected=rs_update("subcategory","catid='$catid',ja_subcat='$jasubcat',status='$status'","id='$editid'");
		if(mysql_affected_rows()>0)
			$_SESSION["msg"]="Product Sub Category Added Successfully";
		else
			$_SESSION["msg"]="Product Sub Category not Added Successfully";
	...
	{
		$rowAffected=rs_update("subcategory","catid='$catid',subcat='$subcat',status='$status'","id='$editid'");
		if(mysql_affected_rows()>0)
			$_SESSION["msg"]="Product Sub Category Added Successfully";
		else
			$_SESSION["msg"]="Product Sub Category not Added Successfully";
	}
	$rowAffected=rs_update("subcategory","seotitle='$title',keyword='$keywords',seodescription='$seodescription',seojatitle='$jatitle',jakeyword='$jakeywords',jaseodescription='$jaseodescription',status='$status',imagepath='$oldimagepath',eurl='$eurl'","id='$editid'");
	if(mysql_affected_rows()>0)
		$_SESSION["msg"]="Product Sub Category Added Successfully";
	else
		$_SESSION["msg"]="Product Sub Category not Added Successfully";
...
else if(isset($_REQUEST['query']) && $_REQUEST['query']=='shipstat')
{
	...
	$statval = $_REQUEST['statval'];
			$upshiporder=mysql_query("update itemorder set shipping_staus='$statval',shipdate='".date("Y-m-d")."' where order_number='$odrnum'");
				if($upshiporder)
				{
