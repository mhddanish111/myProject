...
<form id="frmreg" name="frmreg" method="post" action="AjaxHandler.php">
<input type="hidden" name="query" id="query" value="guestregistration" />
...
<div class="textfelid-box">
 ...
 <div class="checkout-radio-box">
  ...
  <div class="checkout-radio-box">
	...
	<div id="backid"><div id="back-box"><a style="cursor:pointer;" onclick="history.back(-1);" class="link1"> Back</a></div></div>
...
<div class="textfelid-box">
    ...
    <input type="text" name="province" id="province" maxlength="15" class="inp"/>
  </div>
...
<div class="textfelid-box">
	...
	<input name="useremail" id="useremail" type="text" class="inp"  />
  <span id="useravldiv" style="color:#FFFFFF;font-size:12px;float:right;text-align:left;line-height:25px;"></span>
  </div>
...
<div class="textfelid-box">
  ...
  <div class="continue-box" id="continuuehideid"><input type="image" src="../images/continue.jpg" name="continueuser" alt="continue" border="0" onclick="return validateRegForm1(this,'')"; style="cursor:pointer;" /><span id="probar"><?php if(isset($_SESSION['msg']))
  									{
										echo $_SESSION['msg'];
										unset($_SESSION['msg']);
...
<div class="textfelid-box">
      <label>
      <input name="shipuserlastanme" id="shipuserlastanme" type="text" class="inp" />
      </label>
  </div>
  <div class="email-text-box"> Address</div>
<div class="textfelid-box">
...
<div class="textfelid-box">
  ...
  <div class="email-text-box">
     <label for="billing:city">Province/Zip Code</label>
     <div> </div>
  </div>
<div class="textfelid-box">
      <label>
      <input name="shipuserprovince" maxlength="15" id="shipuserprovince" type="text" class="inp" />
      </label>
  </div>
    <div class="email-text-box">Country</div>
<div class="textfelid-box">
...
<div class="textfelid-box">
  ...
  <div class="continue-box" id=""><input type="image" src="../images/continue.jpg" name="continueuser" alt="continue" border="0" onclick="return validateRegForm1(this,'')"; style="cursor:pointer;" /><span id="probar"><?php if(isset($_SESSION['msg']))
  									{
										echo $_SESSION['msg'];
										unset($_SESSION['msg']);
