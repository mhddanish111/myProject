...
$id=$_GET['id'];
$rs=mysql_query("select title ,content as engdata,jacontent as jpdata from cmscontent where id='$id' ") or die(mysql_error());
...
<table width="90%" height="33" border="0" cellpadding="6" cellspacing="0" class="text1">
  <tr>
    <td><h1><font color="#6B6B6B"><?php echo $rsdata['title']; ?></font></h1></td>
		...
		<table width="750" border="0" cellpadding="0" cellspacing="5" bgcolor="#FFFFFF" class="text1">
          <tr>
			...
			<?php
					...
					$oFCKeditor->Value = stripslashes($rsdata["engdata"]);
		  ...
		  <tr>
			...
			<?php
					...
					$oFCKeditor->Value = stripslashes($rsdata["jpdata"]);
					$oFCKeditor->Height = "400";
					$oFCKeditor->Width= "800";
					echo $fck=$oFCKeditor->Create();
					?>
