...
else if(isset($_REQUEST['editsubcat_x']))
{
	...
	if($flag)
	{
		$rowAffected=rs_update("subcategory","seotitle='$title',keyword='$keywords',seodescription='$seodescription',seojatitle='$jatitle',jakeyword='$jakeywords',jaseodescription='$jaseodescription',status='$status',imagepath='$oldimagepath'","id='$editid'");
	if(mysql_affected_rows()>0)
