...
<div class="email-text-box">
    <label id="" for="billing:postcode">Province
</label>
    <div> </div>
  </div>
<div class="textfelid-box">
  <input name="province" id="province" type="text" class="inp" value="<?php echo stripslashes($res['ShipCustZIPCode']); ?>" maxlength="15" />
</div>
